! function(window, document) {
    ...
    var layout = "base",
        settingsName = "remark.material." + layout + ".skinTools",
    ...
    if (settings) {
        ...
        if (settings.sidebar && "dark" === settings.sidebar) var menubarFn = setInterval(function() {
            var menubar = document.getElementsByClassName("site-menubar");
            menubar.length > 0 && (clearInterval(menubarFn), menubar[0].className += " site-menubar-dark")
        }, 5);
        ...
        var $body = $(document.body),
            ...
            Skintools = {
                ...
                sidebarImprove: function(val) {
                    "light" === val ? this.$siteSidebar.removeClass("site-menubar-dark") : "dark" === val && this.$siteSidebar.addClass("site-menubar-" + val)
                },
